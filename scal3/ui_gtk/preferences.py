...
class PreferencesWindow(gtk.Window):
	def __init__(self, **kwargs):
		...
		page.pageIcon = "preferences-desktop-locale.svg"
		...
		page.pageIcon = "preferences-desktop-theme.svg"
		self.prefPages.append(page)
		########
		buttonPadding = 7
		padding = 5
		...
		hboxBut = HBox()
		###
		button = gtk.Button(label=_("_About Plugin"))
		...
		###
		button = gtk.Button(label=_("C_onfigure Plugin"))
		button.set_use_underline(True)
		button.set_image(imageFromIconName(
			"gtk-preferences",
			gtk.IconSize.BUTTON,
		...
		page.pageIcon = "applications-development-web.svg"
		self.prefPages.append(page)
		#####
		treev = gtk.TreeView()
		treev.set_headers_clickable(True)
		...
		toolbar.set_icon_size(size)
		# gtk.IconSize.SMALL_TOOLBAR or gtk.IconSize.MENU
		tb = toolButtonFromFile("starcal.svg", size=sizePixel)
		set_tooltip(tb, _("Register at StarCalendar.net"))
		tb.connect("clicked", self.onAccountsRegisterClick)
		toolbar.insert(tb, -1)
		###########
		tb = toolButtonFromIcon("gtk-add", size)
		set_tooltip(tb, _("Add"))
		tb.connect("clicked", self.onAccountsAddClick)
		toolbar.insert(tb, -1)
		###########
		tb = toolButtonFromIcon("gtk-edit", size)
		set_tooltip(tb, _("Edit"))
		tb.connect("clicked", self.onAccountsEditClick)
		toolbar.insert(tb, -1)
		###########
		tb = toolButtonFromIcon("gtk-delete", size)
		set_tooltip(tb, _("Delete"))
		tb.connect("clicked", self.onAccountsDeleteClick)
		toolbar.insert(tb, -1)
		##########
		tb = toolButtonFromIcon("gtk-go-up", size)
		set_tooltip(tb, _("Move up"))
		tb.connect("clicked", self.onAccountsUpClick)
		toolbar.insert(tb, -1)
		#########
		tb = toolButtonFromIcon("gtk-go-down", size)
		set_tooltip(tb, _("Move down"))
		tb.connect("clicked", self.onAccountsDownClick)
		toolbar.insert(tb, -1)
		###########
		pack(hbox, toolbar)
		pack(vbox, hbox, 1, 1)
