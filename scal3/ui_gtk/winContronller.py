...
class WinConButtonMin(WinConButton):
	...
	imageName = "window-minimize.svg"
	imageNameFocus = "window-minimize-focus.svg"
	imageNameInactive = "window-minimize-inactive.svg"
...
class WinConButtonMax(WinConButton):
	...
	imageName = "window-maximize.svg"
	imageNameFocus = "window-maximize-focus.svg"
	imageNameInactive = "window-maximize-inactive.svg"
...
class WinConButtonClose(WinConButton):
	...
	imageNameFocus = "window-close-focus.svg"
	imageNameInactive = "window-close-inactive.svg"
...
class WinConButtonRightPanel(WinConButton):
	...
	def __init__(self, controller):
		...
		self.imageName = f"window-{direc}.svg"
		self.imageNameFocus = f"window-{direc}-focus.svg"
		self.imageNameInactive = f"window-{direc}-inactive.svg"		
