...
from scal3.ui_gtk.utils import imageFromIconName, imageFromFile
...
class MyStack(gtk.Stack):
	def __init__(
		self,
		iconSize: int = 22,
		iconSizeGtk: gtk.IconSize = gtk.IconSize.BUTTON,
		header: bool = True,
		headerSpacing: int = 5,
		...
		self._iconSizeGtk = iconSizeGtk  # type: gtk.IconSize
